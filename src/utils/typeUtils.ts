...
export const TYPE_MAP_KO_TO_EN: Record<string, string> = {
...
/**
 * 타입 상성 배율을 계산합니다.
 * @param moveType 기술의 타입 (English)
 * @param defenderTypes 방어측 포켓몬의 타입 목록 (Korean)
 * @returns 상성 배율
 */
export const getTypeMultiplier = (moveType: string, defenderTypes: string[]): number => {
  let multiplier = 1;
